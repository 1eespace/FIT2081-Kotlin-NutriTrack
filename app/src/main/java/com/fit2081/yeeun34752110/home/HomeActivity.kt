            ...
            item {
                Column(
                    ...
                    Row(
                        ...
                        Text("Your Food Quality Score", fontSize = 15.sp, style = MaterialTheme.typography.titleMedium)
                        Spacer(modifier = Modifier.weight(1f))
                        Text("$foodQualityScore/100", fontSize = 15.sp, fontWeight = FontWeight.Bold, color = Color(0xFF006400))
                    }
